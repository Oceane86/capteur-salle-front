        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="bg-[#F5F7FA] rounded-lg p-2">
                <Bell className="w-5 h-5 text-[#0092bd]" />
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="bg-[#F5F7FA] rounded-lg p-2">
                <Activity className="w-5 h-5 text-[#0092bd]" />
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="bg-[#F5F7FA] rounded-lg p-2">
                <Settings className="w-5 h-5 text-[#0092bd]" />
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <Settings className="w-5 h-5 text-[#D50000]" />
              ...
              {mockAlerts.map((alert) => (
                <div key={alert.id} className="border-l-4 border-[#FF8F00] bg-[#FFF3E0] rounded-r-lg p-4">
                  <div className="flex items-start gap-3">
                    <Bell className="w-5 h-5 text-[#FF8F00] flex-shrink-0 mt-0.5" />
