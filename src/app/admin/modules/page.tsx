...
export default function AdminModulesPage() {
  ...
  return (
    <>
      <title>Modules | Digital Campus</title>
      <meta name="description" content="Vue d'ensemble des modules IoT" />
      ...
      <div className="min-h-screen bg-[#F5F7FA]">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" role="main">
          {/* Header */}
          <header className="flex items-center justify-between mb-8 flex-wrap gap-4" role="banner">
            <div>
                ...
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Battery className="w-4 h-4 text-[#5F6368]" aria-hidden="true" />
                        <div>
